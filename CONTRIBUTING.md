...
1. At Sikky, we have a single Sikky Open Source Contributor License Agreement that we ask contributors to electronically sign before merging in their
...
2. [Fork](https://github.com/kflash/sikky/fork/) the repository and create your branch from master.
...
By contributing to Sikky, you agree that your contributions will be licensed under its MIT license.